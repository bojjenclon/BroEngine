...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Cornell Daly", "BroEngine", "com.brofist.games.BroEngine", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.brofist.games.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.brofist.games.Main, Reflect.field (com.brofist.games.Main, "main"), []);
...
@:keep class DocumentClass extends com.brofist.games.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "BroEngine", null, { width: 800, height: 600 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.brofist.games.Main, []);
			}
